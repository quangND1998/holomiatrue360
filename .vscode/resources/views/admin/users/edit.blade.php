            ...
            <div class="card">
                <div class="card-header">
                     <div class="d-flex align-items-center">
                        <h4 class="page-title mb-0">@lang('global.app_edit')  @lang('global.user') </h4>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                        ...
                        <div class="form-group py-0 col-md-5 {{ $errors->has('roles') ? 'has-error' : '' }}"">
                            <label>@lang('global.users.fields.roles')</label>
                        ...
                        <div class="mx-auto mt-4 text-center">
                            <a href="{{ url('/admin/users') }}" class="btn btn-danger" style="width: 100px">   @lang('global.app_cancel')</a>
