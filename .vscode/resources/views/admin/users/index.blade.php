...
@section('content')
    <div class="page-header">
        <ul class="breadcrumbs pl-0 ml-md-0 border-0">
            ...
            <li class="nav-item">
                <a  href="{{ url('/admin/users') }}">@lang('global.users.title')</a>
            </li>
        </ul>
                                ...
                                <div class="modal-content">
                                    <div class="modal-header no-bd">
                                        <h2 class="modal-title">
                                            ...
                                            <span class="fw-bold">@lang('global.user')</span>
                                        </h2>
                                            ...
                                            <div class="row" >
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="form-group py-0">
                                                        <label>@lang('global.roles.title')</label>
                                    ...
                                    <div class="modal-footer no-bd">
                                        ...
                                        <button type="submit" id="addRowButton" class="btn btn-info">@lang('global.app_save')</button>
                                    </div>
                                </div>
                            </form>
                        </div>
