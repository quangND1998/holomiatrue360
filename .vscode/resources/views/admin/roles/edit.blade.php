            ...
            <div class="card">
                <div class="card-header">
                     <div class="d-flex align-items-center">
                        <h4 class="page-title mb-0">@lang('global.app_edit') @lang('global.roles.title')</h4>
                    </div>
                </div>
                <div class="card-body">
                   <form action="{{ route('admin.roles.update', $role->id) }}" method="POST">
                    ...
                    {{ method_field('PUT') }}
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            <label for="name"> @lang('global.roles.title')</label>
                        ...
                        <div class="form-group py-0 {{ $errors->has('permission') ? 'has-error' : '' }}" >
                            <label>@lang('global.roles.fields.permission')</label>
                        ...
                        <div class="form-group">
                            <div class="mx-auto mt-4 text-center">
                                <a  href="{{ url('/admin/roles') }}" class="btn btn-danger" style="width: 100px">@lang('global.app_cancel')</a>
