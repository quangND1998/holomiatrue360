                                ...
                                <div class="modal-content">
                                    <div class="modal-header no-bd">
                                        <h2 class="modal-title">
                                            ...
                                            <span class="fw-bold">@lang('global.roles.title')</span>
                                        </h2>
                                            ...
                                            <div class="row" >
                                                <div class="col-sm-12">
                                                    <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                                        <label>@lang('global.roles.fields.name')</label>
                                                    ...
                                                    <div class="form-group py-0">
                                                        <label>@lang('global.chose_permissions')</label>
                                    ...
                                    <div class="modal-footer no-bd">
                                        <a href="{{ url('/admin/roles') }}" type="button" class="btn btn-danger" data-dismiss="modal">@lang('global.app_cancel')</a>
                         ...
                         <table id="add-row" class="display table table-striped table-hover {{ count($roles) > 0 ? 'datatable' : '' }} dt-select">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('global.permissions.title')</th>
