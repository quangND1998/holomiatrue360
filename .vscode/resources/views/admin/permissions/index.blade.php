                                ...
                                <div class="modal-content">
                                    <div class="modal-header no-bd">
                                        <h2 class="modal-title">
                                            <span class="fw-bold">@lang('global.permissions.title')</span>
                                            ...
                                            <div class="row" >
                                                <div class="col-sm-12">
                                                    <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                                        <label>@lang('global.permissions.fields.name')</label>
                                                        <input id="addName" type="text" name="name" class="form-control" placeholder="@lang('input.permissions.permission_input')" required oninvalid="setCustomValidity('@lang('input.permissions.required_permission')')">
                                                        @if ($errors->has('title'))
                                                            <span class="text-red" >
