<div class="main-header" data-background-color="dark">
    ...
    <div class="logo-header">
        <a href="javascript:void(0)" class="logo">
            <img src="asset/img/logo-true360-2.svg" alt="navbar brand" class="navbar-brand">
        </a>
    ...
    <nav class="navbar navbar-header navbar-expand-lg">
        ...
        <div class="container-fluid">
            <div class="collapse" id="search-nav">
                <form class="navbar-left navbar-form nav-search mr-md-3 mb-0">
            ...
            <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                ...
                <div class="top-right">
                    {{-- <li class=" navbar-nav nav-item flat">
                        <a href="{{url(Request::getPathInfo().'?lang=en')}}" class="mr-2"><img src="admin/images/flat/en.png"></a>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="{{url(Request::getPathInfo().'?lang=en')}}"><img src="admin/images/flat/en.png" class="mr-1">@lang('global.english')</a>
                            <a class="dropdown-item" href="{{url(Request::getPathInfo().'?lang=vn')}}"><img src="admin/images/flat/vn.png" class="mr-1">@lang('global.vietnamese')</a>
                        </div>
                    </div>
                </div>
