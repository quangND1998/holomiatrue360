                ...
                <div class="tab-pane fade show active" id="pills-info" role="tabpanel" aria-labelledby="pills-info-tab">
                    <div class="row">
                        <div class ="col-md-6">
                            ...
                            <div class="image-upload-wrap col-md-8" id="wrap-logo" style="display: none">
                            ...
                            <div class="file-upload-content col-md-8" id="file-upload-logo" style="display: block">
                                <img class="file-upload-image" id="upload-logo" src="{{$inforproject->logo}}" alt="your image" />
                            ...
                            <div class="form-group {{ $errors->has('thumbnail') ? 'has-error' : '' }}">
                                ...
                                <div class="image-upload-wrap col-md-8" id="wrap-thumbnail" style="display: none">
                                ...
                                <div class="file-upload-content col-md-8" id="file-upload-thumbnail" style="display: block">
                                    <img class="file-upload-image" id="upload-thumbnail" src="{{$inforproject->thumbnail}}" alt="your image" />
                                    <span class="image-title-wrap" title="Xóa">
                                        <i class="fas fa-times fa-2x"></i>
                                    </span>
                                </div>
