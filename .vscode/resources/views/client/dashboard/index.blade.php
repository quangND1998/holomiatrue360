                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col col-stats ml-3 ml-sm-0">
                                    <div class="numbers">
                                        ...
                                        <h4 class="card-title">{{ $live_users }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card card-stats card-round">
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col col-stats ml-3 ml-sm-0">
                                    <div class="numbers">
                                        <p class="card-category">Page View</p>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body pb-0">
                            ...
                            <div class="d-flex">
                                <div class="avatar">
                                    <img src="../asset/img/logoproduct2.svg" alt="..." class="avatar-img rounded-circle">
                                </div>
                                <div class="flex-1 pt-1 ml-2">
                            ...
                            <div class="d-flex">
                                <div class="avatar">
                                    <img src="../asset/img/logoproduct3.svg" alt="..." class="avatar-img rounded-circle">
                                </div>
                                <div class="flex-1 pt-1 ml-2">
