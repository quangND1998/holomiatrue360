...
@section('content')
    <div class="page-header">
        <ul class="breadcrumbs pl-0 ml-md-0 border-0">
            ...
            <li class="nav-item">
                <a  href="{{ route('admin.dashboard') }}">@lang('global.projects.title')</a>
            </li>
        </ul>
    </div>
                                ...
                                <div class="modal-content">
                                    <div class="modal-header no-bd">
                                        <h2 class="modal-title">
                                            <span class="fw-bold">@lang('global.app_create')</span>
                                            <span class="fw-bold">@lang('global.project')</span>
                                        </h2>
                                            ...
                                            <div class="row" >
                                                <div class="col-sm-12">
                                                    <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                                        <label>@lang('global.projects.fields.name')</label>
                                    ...
                                    <div class="modal-footer no-bd">
                                        <button type="button" class="btn btn-danger" data-dismiss="modal">@lang('global.app_cancel')</button>
                                        <button type="submit" id="addRowButton" class="btn btn-info">@lang('global.app_create')</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="form-button-action">
                                            <a  href="{{ route('admin.info.editProject',[$project->id]) }}" type="button" data-toggle="tooltip" title="" class="btn btn-link btn-info btn-lg" data-original-title=@lang('global.app_edit')>
