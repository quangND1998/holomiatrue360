...
class ProjectController extends Controller
{
    ...
    public function store(CreateProjectRequest $request)
    {
        if(Gate::allows(config('constants.CREATE_PROJECT_PERMISSION'))){
            ...
            $this->createFolder($public,Str::slug($project->title));
            $this->createFolder($public,Str::slug($project->title).'/'.'2Dimage');
            $this->createFolder($public,Str::slug($project->title).'/'.'360image');
