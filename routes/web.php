...
Route::group(['middleware' => ['lang']], function() {
    ...
    $this->get('logout', 'Auth\LoginController@logout_user')->name('auth.logout');
    ...
    $this->get('login/reset', 'Auth\ForgotPasswordController@showLinkRequestForm')->name('auth.password.reset');
    ...
    Route::group(['middleware' => ['auth'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
        ...
        Route::group(['prefix' => 'project'], function () {
            ...
            //Amentites
            Route::get('/{id}/amentities','Amentities\AmentitiesController@getAmentities')->name('amentities.show');
...
Route::get('mangesubdivision/{id}','Subdivision\SubdivisionController@manageSubdivision');
/*
    GenneralView( Tong the)
*/
Route::post('general/storeprensent/{id}','GeneralView\GeneralViewController@storePresentImg');
Route::post('general/storeImgNight_Day/{id}','GeneralView\GeneralViewController@storeImgNight_Day');
Route::post('general/updateImgNight_Day/{id}','GeneralView\GeneralViewController@updateImgNight_Day');
// Route::post('modelAR/generalstoreglb/{id}','ModelAr\ModelArController@generalstoreGLB');
// Route::post('modelAR/generalstoreusdz/{id}','ModelAr\ModelArController@storeUSDZ');
/*
   ModelAR
*/
Route::post('modelAR/update/{id}','ModelAr\ModelArController@update');
Route::post('modelAR/generalstore/{id}','ModelAr\ModelArController@generalstore');
Route::post('modelAR/subdivisionstore/{id}','ModelAr\ModelArController@subdivisionstore');
/*
   Group (Mat Bang)
*/
Route::post('ground/store/{id}','Ground\GroundController@store');
Route::post('ground/update/{id}','Ground\GroundController@update');
/*
   Map(Ban Do)
*/
Route::post('map/store/{id}','Map\MapController@map_store');
Route::post('map/update/{id}','Map\MapController@map_update');
Route::post('map/findMap','Map\MapController@findMap');
Route::post('showflat/store/{id}','ShowFlat\ShowFlatController@storeShowFlat');
Route::post('add-subdivision/{id}','Subdivision\SubdivisionController@addSubdivision')->name('add-subdivision');